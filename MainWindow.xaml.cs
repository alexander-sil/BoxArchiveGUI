...
namespace BoxArchiveGUI
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void DecompressButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            dialog.Title = "Выбрать архив для обработки";
            dialog.Filter = "Файлы BOX (*.box)|*.BOX";
            ...
            if (dialog.ShowDialog() == true)
            {
                ...
                MessageBoxResult answer = MessageBox.Show("Показать извлечённые файлы?", "", MessageBoxButton.YesNo);
